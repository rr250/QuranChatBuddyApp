...
export const PrayerTimesCard = () => {
  ...
  const allPrayers = [
    { name: 'Fajr', time: prayerTimes.fajr, icon: '🌅', color: theme.colors.fajr },
    { name: 'Dhuhr', time: prayerTimes.dhuhr, icon: '☀️', color: theme.colors.dhuhr },
    { name: 'Asr', time: prayerTimes.asr, icon: '🌤️', color: theme.colors.asr },
    { name: 'Maghrib', time: prayerTimes.maghrib, icon: '🌆', color: theme.colors.maghrib },
    { name: 'Isha', time: prayerTimes.isha, icon: '🌙', color: theme.colors.isha },
  ];
    ...
    <Card style={styles.card}>
      <Card.Content>
        ...
        {currentPrayer && (
          <Chip
            mode="outlined"
            style={[styles.currentPrayerChip, { borderColor: theme.colors.primary }]}
        ...
        <View style={styles.prayersList}>
          {allPrayers.map((prayer, index) => (
            <View key={index} style={styles.prayerRow}>
              ...
              <View style={[styles.prayerTimeBadge, { backgroundColor: prayer.color + '15' }]}>
                <Text style={[styles.prayerTime, { color: prayer.color }]}>
                  {prayerService.formatPrayerTime(prayer.time)}
                </Text>
              </View>
            </View>
          ))}
